...
Route::middleware(['auth', 'verified', 'role:admin,special'])->group(function () {
  ...
  Route::get('/dokumen/backdate/create', [DokumenController::class, 'createBackdate'])->name('dokumen.create.backdate');
  Route::post('/dokumen/backdate', [DokumenController::class, 'storeBackdate'])->name('dokumen.store.backdate');
});

// Grup HANYA untuk ADMIN
Route::middleware(['auth', 'verified', 'role:admin'])->group(function () {
  // Rute manajemen dokumen (edit, update, delete)

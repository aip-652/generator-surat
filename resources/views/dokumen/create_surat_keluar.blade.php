                ...
                <div class="p-6 md:p-8 bg-white border-b border-gray-200">
                    ...
                    @if (session('success'))
                        ...
                        <div
                            ...
                            <span>
                                Surat Keluar berhasil dibuat dengan nomor:
                    ...
                    <form action="{{ route('dokumen.store.surat') }}" method="POST" class="space-y-6">
                        ...
                        <div id="tanggal-container" class="hidden">
                            ...
                            <x-text-input id="tanggal_manual" class="block mt-1 w-full" type="date"
                                name="tanggal_manual" :value="old('tanggal_manual')" />

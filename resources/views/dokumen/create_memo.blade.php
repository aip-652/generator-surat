        ...
        <div class="p-6 md:p-8 bg-white border-b border-gray-200">
          ...
          <form action="{{ route('dokumen.store.memo') }}" id="dokumenform" method="POST" class="space-y-6">
            ...
            <div>
              ...
              <x-select-input id="tujuan" class="block mt-1 w-full searchable" name="tujuan" :value="old('tujuan')" required>
            ...
            <div>
              ...
              <x-select-input id="dari" class="block mt-1 w-full searchable" name="dari" :value="old('dari')" required>
            ...
            <div>
              ...
              <x-select-input id="tembusan" class="block mt-1 w-full searchable" name="tembusan" :value="old('tembusan')" required>
              ...
              <x-input-error :messages="$errors->get('tembusan')" class="mt-2" />
            </div>

            <div>
              <x-input-label for="perihal" :value="__('Perihal')" />
              <x-text-input id="perihal" class="block mt-1 w-full" type="text" name="perihal" :value="old('perihal')"
                required />
